    ...
    return (
        <div className={styles['shopping-cart']}>
            ...
            <div className={styles.cols}>
                <div className={`${styles.col} ${styles['left-col']}`}><h4>Cart Items Container</h4><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae nemo minus placeat amet, quis ex ea? Eveniet inventore quas cumquht</p></div>
